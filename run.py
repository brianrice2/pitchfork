"""
This scripts receives command-line arguments from the user and delegates
...
logging.config.fileConfig(pkg_resources.resource_filename(__name__, "config/logging/local.conf"), disable_existing_loggers=False)
